      ...
      <Card className={`relative flex flex-col ${
        ...
        {isPopular && (
          <div className="absolute -top-5 inset-x-0">
            <div className="px-3">
              <Badge
                className="w-full py-2.5 bg-purple-500 flex justify-center items-center text-sm font-medium rounded-md border-purple-500 hover:bg-purple-500 hover:text-white shadow-sm"
                variant="secondary"
              >
